...
if (!file_exists(ROOT . DS . 'Config' . DS . 'database.php') || !file_exists(ROOT . DS . 'Config' . DS . 'install')) {
	...
	Router::connect('/', array('plugin' => 'site', 'controller' => 'pages', 'action' => 'index'));
	Router::connect('/admin', array('plugin' => 'System', 'controller' => 'system', 'action' => 'index', 'admin' => true));
	Router::connect('/pages/*', array('plugin' => 'site', 'controller' => 'pages', 'action' => 'index'));
	Router::connect('/site/ajax/*', array('plugin' => 'site', 'controller' => 'site', 'action' => 'ajax'));
	Router::connect('/produto/*', array('plugin' => 'site', 'controller' => 'pages', 'action' => 'produto'));

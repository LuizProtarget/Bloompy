	...
	{		
		if($this->params['isAjax'])
		{
			...
			if(is_array($skus))
				...
				{
					$rows[]= '{"referencia":"'.$sku_row['referencia'].'", "cor":"'.$sku_row['cor'].'", "produto_cor_id":"'.$sku_row['produto_cor_id'].'", "produto_sku_id":"'.$sku_row['produto_sku_id'].'", "exibir_site":"'.$sku_row['exibir_site'].'", "exibir_mobile":"'.$sku_row['exibir_mobile'].'"}';
				}

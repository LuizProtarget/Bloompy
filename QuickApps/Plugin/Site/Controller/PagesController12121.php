...
class PagesController extends AppController {
	...
	public function index($param = null) {
		...
		if($render == 'colecao'){
			...
			$dados['colecoes'] = $this->Produtos->getColecao(true,'position');
			//var_dump($dados);die;
	...
	public function aplicativo($param = null)
	{
		...
		elseif($render == 'completo'){
			...
			if(isset($this->data['user']) && isset($this->data['password'])){
				...
				$verify = $this->__login($this->data['user'],$this->data['password'],$data);
			...
			$dados = $this->Produtos->getColecao(false,'name');

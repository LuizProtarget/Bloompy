<?php echo $this->Form->create('User', array('url' => "/admin/site/userApp/add/")); ?>
	<!-- Settings -->
	<?php echo $this->Html->useTag('fieldsetstart', __t('Add new user')); ?>
		...
		<?php echo $this->Form->input('public_email', array('type' => 'hidden', 'value' => 0)); ?>
		<?php echo $this->Form->input('language', array('type' => 'hidden', 'value' => 'por', 'label' => __t('Language'))); ?>
		<?php App::import('Lib', 'Locale.QALocale'); ?>
		<?php echo $this->Form->input('timezone', array('type' => 'hidden', 'value' => Configure::read('Variable.date_default_timezone'), 'label' => __t('Time zone'))); ?>
		...
		<?php echo $this->Form->input('Role.Role', array('type' => 'hidden',  'value' => 6)); ?>

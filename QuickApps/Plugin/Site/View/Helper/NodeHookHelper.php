 ...
 */
	public function beforeLayout($layoutFile) {
		...
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_lojas') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}

		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_loja_add') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_loja_edit') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_representantes') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_representante_add') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_representante_edit') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_lojas_virtuais') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_loja_virtual_add') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if (Router::getParam('admin') && $this->request->params['plugin'] == 'site' && $this->request->params['action'] == 'admin_loja_virtual_edit') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if ($this->request->params['controller'] == 'cidade' || $this->request->params['controller'] == 'estado' || $this->request->params['controller'] == 'pais') {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		
		if ($this->request->params['controller'] == 'userApp' ) {
			$this->_View->Block->push(array('body' => $this->_View->element('toolbar') . '<!-- SiteHookHelper -->'), 'toolbar');
		}
		return true;
	}
